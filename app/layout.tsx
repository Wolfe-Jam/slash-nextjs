...
export const metadata: Metadata = {
  icons: {
    icon: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='15' fill='%230a0a0a'/><circle cx='50' cy='50' r='32' fill='%23EAB308' stroke='%23fff' stroke-width='2'/><text x='50' y='60' font-size='28' text-anchor='middle' fill='%230a0a0a' font-family='system-ui' font-weight='900'>$</text></svg>",
  },
